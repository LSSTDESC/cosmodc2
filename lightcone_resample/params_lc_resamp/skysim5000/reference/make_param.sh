...
healpix_groups=("9559  9686  9687  9814  9815  9816  9942  9943 10070 10071 10072 10198 10199 10200 10326 10327 10450")
healpix_group_names=("grp1" "grp2" "grp3" "grp4" "grp5" "grp6")
v1=1
v2=0
v3=0
mkdir logs
mkdir logs/old
rm *${cat_name}*
logdir="params_lc_resamp/${cat_name}_v${v1}.${v2}.${v3}/logs"
echo "#!/bin/bash" >"submit_all.sh"
echo "#!/bin/bash" >"run_all_login.sh"
echo "mv ${logdir}/*.err ${logdir}/old/." >> "submit_all.sh"
echo "mv ${logdir}/*.out ${logdir}/old/." >> "submit_all.sh"
for i in "${!z_ranges[@]}";do
	...
	sed "s/#z_range#/${z_range}/g; s/#step_list#/${steps}/g; s@#gltcs_file#@${gltcs_file}@g; s/#z_type#/${z_type}/g; s/#healpix_group#/${healpix_group}/g; s/#v1#/${v1}/g; s/#v2#/${v2}/g; s/#v3#/${v3}/g"<template.param >${cat_name}_v${v1}.${v2}.${v3}_z_${z_range}_hp:${healpix_name}.param
	sed "s/#z_range#/${z_range}/g; s/#step_list#/${steps}/g; s@#gltcs_file#@${gltcs_file}@g; s/#z_type#/${z_type}/g; s/#healpix_name#/${healpix_name}/g; s/#v1#/${v1}/g; s/#v2#/${v2}/g; s/#v3#/${v3}/g; s/#cat_name#/${cat_name}/g"<template.sh >run_${cat_name}_v${v1}.${v2}.${v3}_z_${z_range}_hp:${healpix_name}.sh
	chmod +x run_${cat_name}_v${v1}.${v2}.${v3}_z_${z_range}_hp:${healpix_name}.sh
    echo "qsub -n 1 -t 720 -A LSSTsky -o params_lc_resamp/${cat_name}_v${v1}.${v2}.${v3}/logs/${z_range}_${healpix_name}.out -e params_lc_resamp/${cat_name}_v${v1}.${v2}.${v3}/logs/${z_range}_${healpix_name}.err  --debuglog=params_lc_resamp/${cat_name}_v${v1}.${v2}.${v3}/logs/${z_range}_${healpix_name}.cobalt  ./lc_resample.py params_lc_resamp/${cat_name}_v${v1}.${v2}.${v3}/${cat_name}_v${v1}.${v2}.${v3}_z_${z_range}_hp:${healpix_name}.param" >> "submit_all.sh"
    echo "./lc_resample.py params_lc_resamp/${cat_name}_v${v1}.${v2}.${v3}/${cat_name}_v${v1}.${v2}.${v3}_z_${z_range}_hp:${healpix_name}.param" >> "run_all_login.sh"
    done
done
