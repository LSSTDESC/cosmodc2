...
set xtra_args = "-output_mock_dirname baseDC2_min_9.8_centrals_zsmear_nzdivs -synthetic_mass_min 9.8 -gaussian_smearing 0.03 -nzdivs 10"
set xtra_label = "9.8_centrals_zsmear_0.03_nzdivs_10"
if(${xtra_label} != "") then
