...
set xtra_args = "-input_master_dirname cosmology/DC2/OR_Production -output_mock_dirname baseDC2_9.8C_v1.1 -gaussian_smearing 0.03 -nside 32"
set xtra_label = "9.8C_production_v1.1"
if(${xtra_label} != "") then
